...
```{r load_2009_lc, warning = FALSE, message = FALSE}
...
ggplot() +
  ...
  geom_point(data=Travis_landUse, aes(x=xyC(Travis_landUse)[,1], 
                                        ...
                                        shape = 15, size = 1.5) +
  geom_sf(data=st_intersection(austinHighways,filter(studyAreaCounties, NAME=="Travis")), size=1, color = "yellow") +
